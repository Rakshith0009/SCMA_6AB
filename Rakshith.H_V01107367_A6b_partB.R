...
setwd('/Users/preethireddy/Desktop/untitled folder 3')
getwd()
...
# Load the dataset
df <- read_excel('excel.xlsx', sheet = "Monthly Prices", skip = 6)
...
r <- 0 # Replace with the actual number from the test results
